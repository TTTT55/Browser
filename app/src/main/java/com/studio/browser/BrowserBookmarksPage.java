...
public class BrowserBookmarksPage extends Fragment implements View.OnCreateContextMenuListener,
    ...
    public boolean onContextItemSelected(MenuItem item) {
        if (!(item.getMenuInfo() instanceof BookmarkExpandableView.BookmarkContextMenuInfo)) {
            return false;
        }
        BookmarkExpandableView.BookmarkContextMenuInfo i = (BookmarkExpandableView.BookmarkContextMenuInfo) item.getMenuInfo();
