...
public class DataController {
    ...
    class DataControllerHandler extends Thread {
            ...
            case TAB_DELETE_THUMBNAIL:
                ...
                try {
                    cr.delete(ContentUris.withAppendedId(
                            BrowserProvider2.Thumbnails.CONTENT_URI, (Long)msg.obj),
                            null, null);
                } catch (Throwable t) {}
                break;
        ...
        private void doSaveThumbnail(Tab tab) {
            ...
            values.put(BrowserProvider2.Thumbnails._ID, tab.getId());
            values.put(BrowserProvider2.Thumbnails.THUMBNAIL, blob);
        ...
        private void doLoadThumbnail(Tab tab) {
            ...
            try {
                ...
                c = cr.query(uri, new String[] {BrowserProvider2.Thumbnails._ID,
                        BrowserProvider2.Thumbnails.THUMBNAIL}, null, null, null);
                if (c.moveToFirst()) {
        ...
        private void doUpdateVisitedHistory(String url) {
            ...
            try {
                ...
                if (c.moveToFirst()) {
                    ...
                    com.studio.browser.misc.Browser.truncateHistory(cr);
                    ContentValues values = new ContentValues();
